...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .action-button {
            ...
            white-space: pre-line; /* ✅ allows line break in text */
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: right; margin: 20px; margin-bottom: 0;">
        <asp:LinkButton ID="Logout_Link" runat="server" OnClick="Logout_Link_Click" 
            ...
            <img src="Images/logout.jpg" alt="Logout" 
                style="vertical-align: middle; width: 24px; height: 24px; margin-right: 5px;" />
        </asp:LinkButton>
    </div>
    ...
    <!-- ✅ Wrap buttons in UpdatePanel -->
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="button-panel">
                <div style="text-align:center; margin-top: 20px;">
                    <asp:Button ID="UserRequests_btn" runat="server" Text="User Requests"
                        CssClass="action-button" OnClick="UserRequests_btn_Click" Width="306px" />
                </div>
                <div style="text-align:center; margin-top: 20px;">
                    <asp:Button ID="AccountRequests_btn" runat="server" Text="Account Requests"
